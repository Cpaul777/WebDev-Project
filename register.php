...
<body>
    ...
    title="Password must be 8-32 characters, include at least one letter and one number."><br>
           ...
           <input type="text" name="phone" id="phone" required pattern="[0-9]{7,15}" maxlength="15" title="Enter a valid phone number (numbers only)">
            ...
            <input type="text" name="emergency_phone" id="emergency_phone" required pattern="[0-9]{7,15}" maxlength="15" title="Enter a valid emergency phone number (numbers only)">
